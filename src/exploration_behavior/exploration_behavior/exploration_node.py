...
"""
Exploration node to move sequentially to multiple waypoints.
"""
...
def main():
    ...
    waypoints = [
        PoseStamped(pose=pose_from_xytheta(0.5, 0.0, 0.0)),
        PoseStamped(pose=pose_from_xytheta(1.0, 1.0, 0.0)),
        PoseStamped(pose=pose_from_xytheta(1.0, 1.0, 0.0)),
        PoseStamped(pose=pose_from_xytheta(1.0, 1.0, 0.0)),
        PoseStamped(pose=pose_from_xytheta(1.0, 1.0, 0.0)),
        PoseStamped(pose=pose_from_xytheta(1.0, 1.0, 0.0)),

...
class ObjectDetector(Node):
    ...
    def __init__(self):    
        ...
        self.image_with_boxes_pub = self.create_publisher(Image, '/limo/yolo_detected_image', 10)
    ...
    def image_color_callback(self, data):
        ...
        model = YOLO("src/yolov8_object_detection/runs/detect/train2/weights/best.pt")
